#############################################################################
# Makefile for building: build/Qucs-RFlayout
# Generated by qmake (2.01a) (Qt 4.8.7) on: jeu. janv. 24 21:07:50 2019
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Qucs-RFlayout1.0.0 || $(MKDIR) .tmp/Qucs-RFlayout1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Qucs-RFlayout1.0.0/ && $(COPY_FILE) --parents element.h eqn.h pac.h mcorn.h mcoupled.h mcross.h mgap.h mlin.h mmbend.h mopen.h mrstub.h mstep.h mtee.h mvia.h parser.h xycalculator.h layoutwriter.h mainwindow.h .tmp/Qucs-RFlayout1.0.0/ && $(COPY_FILE) --parents main.cpp element.cpp eqn.cpp pac.cpp mcorn.cpp mcoupled.cpp mcross.cpp mgap.cpp mlin.cpp mmbend.cpp mopen.cpp mrstub.cpp mstep.cpp mtee.cpp mvia.cpp parser.cpp xycalculator.cpp layoutwriter.cpp mainwindow.cpp .tmp/Qucs-RFlayout1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Qucs-RFlayout1.0.0/ && (cd `dirname .tmp/Qucs-RFlayout1.0.0` && $(TAR) Qucs-RFlayout1.0.0.tar Qucs-RFlayout1.0.0 && $(COMPRESS) Qucs-RFlayout1.0.0.tar) && $(MOVE) `dirname .tmp/Qucs-RFlayout1.0.0`/Qucs-RFlayout1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Qucs-RFlayout1.0.0
