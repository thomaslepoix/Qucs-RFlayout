...
//	         "\t\tdisp(\"\\t                     'F' is a scientific number, eg. '2.3e9'. By default 'F' is where S11 is minimal.\");\n"
	         ...
	         "\t\tdisp(\"\\t--nf2ff-frames       Number of 3D frames. Default is 0 or 1 : only 1 frame 'F' specified with '--nf2ff-f'.\");\n"
...
//	f_out << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n"
	...
	f_out << "%%%% ELEVATION\n"
	         ...
	         "\tcolor_order(1, :); ...\n"
	         "\tcolor_order(2, :)];\n"
	         "nf2ff = CalcNF2FF(nf2ff, path_simulation, f_res, ...\n"
	         ...
	         "set(h, 'Linewidth', 2);\n"
	         "drawnow;\n"
	         "print([path_result, '/', name, '-ffp-elev-dbn', graphics_format]);\n"
	         "\n"
	         "% Polar dBi\n"
	         "figure;\n"
	         "set(gca, 'ColorOrder', color_order_polar, 'NextPlot', 'replacechildren');\n"
	         ...
	         "set(h, 'Linewidth', 2);\n"
	         "drawnow;\n"
	         "print([path_result, '/', name, '-ffp-elev-dbi', graphics_format]);\n"
	         "\n"
	         "% Rect dBi\n"
	         "figure;\n"
	         ...
	         "set(h, 'Linewidth', 2);\n"
	         "drawnow;\n"
	         "print([path_result, '/', name, '-ffr-elev-dbi', graphics_format]);\n"
	         "\n";
	...
	f_out << "%%%% AZIMUTH\n"
	         ...
	         "set(h, 'Linewidth', 2);\n"
	         "drawnow;\n"
	         "print([path_result, '/', name, '-ffp-azim-dbn', graphics_format]);\n"
	         "\n"
	         "% Polar dBi\n"
	         "figure;\n"
	         "set(gca, 'ColorOrder', color_order_polar, 'NextPlot', 'replacechildren');\n"
	         ...
	         "set(h, 'Linewidth', 2);\n"
	         "drawnow;\n"
	         "print([path_result, '/', name, '-ffp-azim-dbi', graphics_format]);\n"
	         "\n"
	         "% Rect dBi\n"
	         "figure;\n"
	         "set(gca, 'ColorOrder', color_order, 'NextPlot', 'replacechildren');\n"
	         ...
	         "set(h, 'Linewidth', 2);\n"
	         "drawnow;\n"
	         "print([path_result, '/', name, '-ffr-azim-dbi', graphics_format]);\n"
	         "\n";
	...
	f_out << "%%%% 3D\n"
	         ...
	         "\tfreqs = f_res;\n"
	         "endif\n"
	         "nf2ff = CalcNF2FF(nf2ff, path_simulation, freqs, theta_range*pi/180, phi_range*pi/180, ...\n"
	         "\t'Center', nf2ff.center, ...\n"
	         "\t'Verbose', 1, 'Mode', flag_nf2ff_mode, 'Outfile', 'nf2ff_3d.h5');\n"
	         "\n"
	         "% V/m\n"
	         "plotFF3D_frames(nf2ff, [path_result, '/', name, '-ff3d-vm'], 'gif', ...\n"
	         "\t'unique_color_scale', 'unique_axis_scale');\n"
	         "\n"
/*	         "% V/m\n"
	         "figure;\n"
