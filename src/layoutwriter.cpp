...
//	         "\t\tdisp(\"\\t                       'F' is a scientific number, eg. '2.3e9'. By default 'F' is where S11 is minimal.\");\n"
	         ...
	         "\t\tdisp(\"\\t--nf2ff-frames <I>     Number of 3D frames to merge in a .gif. Default (0, 1 or nothing) : use default or --f* args\");\n"
	         "\t\tdisp(\"\\t                       specified frequencies and no .gif generated.\");\n"
...
//	f_out << "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n"
	...
	f_out << "%%%% ELEVATION\n"
	         ...
	         "\tset(h, 'Linewidth', 2);\n"
	         "\tdrawnow;\n"
	         "\tprint([path_result, '/', name, '-ffp-elev-dbn@', ...\n"
	         "\t\tnum2str(f_select(i), frequency_format), ...\n"
	         "\t\tgraphics_format]);\n"
	         "endfor\n"
	         "\n"
	         ...
	         "\tset(h, 'Linewidth', 2);\n"
	         "\tdrawnow;\n"
	         "\tprint([path_result, '/', name, '-ffp-elev-dbi@', ...\n"
	         "\t\tnum2str(f_select(i), frequency_format), ...\n"
	         "\t\tgraphics_format]);\n"
	         "endfor\n"
	         "\n"
	         ...
	         "\tset(h, 'Linewidth', 2);\n"
	         "\tdrawnow;\n"
	         "\tprint([path_result, '/', name, '-ffr-elev-dbi@', ...\n"
	         "\t\tnum2str(f_select(i), frequency_format), ...\n"
	         "\t\tgraphics_format]);\n"
	         "endfor\n"
	         "\n";
	...
	f_out << "%%%% AZIMUTH\n"
	         ...
	         "\tset(h, 'Linewidth', 2);\n"
	         "\tdrawnow;\n"
	         "\tprint([path_result, '/', name, '-ffp-azim-dbn@', ...\n"
	         "\t\tnum2str(f_select(i), frequency_format), ...\n"
	         "\t\tgraphics_format]);\n"
	         "endfor\n"
	         "\n"
	         ...
	         "\tset(h, 'Linewidth', 2);\n"
	         "\tdrawnow;\n"
	         "\tprint([path_result, '/', name, '-ffp-azim-dbi@', ...\n"
	         "\t\tnum2str(f_select(i), frequency_format), ...\n"
	         "\t\tgraphics_format]);\n"
	         "endfor\n"
	         "\n"
	         ...
	         "\tset(h, 'Linewidth', 2);\n"
	         "\tdrawnow;\n"
	         "\tprint([path_result, '/', name, '-ffr-azim-dbi@', ...\n"
	         "\t\tnum2str(f_select(i), frequency_format), ...\n"
	         "\t\tgraphics_format]);\n"
	         "endfor\n"
	         "\n";
	...
	f_out << "%%%% 3D\n"
	         ...
	         "\n"
	         "% V/m\n"
	         "plotFF3D_frames(nf2ff_3d, [path_result, '/', name, '-ff3d-vm'], ...\n"
	         "\t'gif', gif, 'show_each', show_each, ...\n"
	         "\t'unique_color_scale', 'unique_axis_scale');\n"
	         "\n"
/*	         "% V/m\n"
	         "figure;\n"
