...
% PORTS
\draw [line width=2pt] (\ox,\oy) ++(-1.5,0) +(0,-0.5) -- +(0,0.5);
\draw [line width=2pt] (\ox,\oy) ++(1.5,0) +(0,-0.5) -- +(0,0.5);
...
\path [tips, -{Stealth[length=5pt]}](\ox,\oy) ++(0,0.5) -- +(0,2.5pt) node[above] {C1};
\path [tips, -{Stealth[length=5pt]}](\ox,\oy) ++(-1.5,0) -- +(-2.5pt,0) node[left] {I1};
\path [tips, -{Stealth[length=5pt]}](\ox,\oy) ++(1.5,0) -- +(2.5pt,0) node[right] {I2};
