...
\draw [line width=2pt] (\ox,\oy) ++(0,1) node[below] {2} +(-1,0) -- +(1,0);
\draw [line width=2pt] (\ox,\oy) ++(1,0) node[left] {3} +(0,-0.5) -- +(0,0.5);
\draw [line width=2pt] (\ox,\oy) ++(0,-1) node[above] {4} +(-0.5,0) -- +(0.5,0);
...
% PORTS
\draw [line width=2pt] (\ox,\oy) ++(-1,0) node[right] {1} +(0,-0.5) -- +(0,0.5);
\draw [line width=2pt] (\ox,\oy) ++(0,1) node[below] {2} +(-0.5,0) -- +(0.5,0);
\draw [line width=2pt] (\ox,\oy) ++(1,0) node[left] {3} +(0,-1) -- +(0,1);
\draw [line width=2pt] (\ox,\oy) ++(0,-1) node[above] {4} +(-1,0) -- +(1,0);
