...
% MCORN
\draw (\fpeval{9*\stepx-\stepx/2},\fpeval{9*\stepy-\stepy/2}) node(mcorn) {\textbf{MCORN}};
...
% MMBEND
\draw (\fpeval{10*\stepx-\stepx/2},\fpeval{9*\stepy-\stepy/2}) node(mmbend) {\textbf{MMBEND}};
...
% MTEE
\draw (\fpeval{11*\stepx-\stepx/2},\fpeval{9*\stepy-\stepy/2}) node(mtee) {\textbf{MTEE}};
...
% MCROSS
\draw (\fpeval{12*\stepx-\stepx/2},\fpeval{9*\stepy-\stepy/2}) node(mcross) {\textbf{MCROSS}};
...
% MCOUPLED
\draw (\fpeval{13*\stepx-\stepx/2},\fpeval{9*\stepy-\stepy/2}) node(mcoupled) {\textbf{MCOUPLED}};
